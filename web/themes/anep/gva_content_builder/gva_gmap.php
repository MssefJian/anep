   ...
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       ?>
         ...
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('anep')) ?>/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('anep')) ?>/vendor/jquery.ui.map.min.js"></script>
