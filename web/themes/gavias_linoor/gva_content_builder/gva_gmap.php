...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         $google_api = theme_get_setting('google_key');
       ...
       ?>
         ...
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_linoor')) ?>/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_linoor')) ?>/vendor/jquery.ui.map.min.js"></script>
